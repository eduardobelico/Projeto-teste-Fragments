...
class NoticiasActivity : AppCompatActivity() {
    ...
    private fun FragmentTransaction.configuraContainerFragmentVisualizaNoticia() =
        if (activity_noticias_container2 != null) {
            R.id.activity_noticias_container2
        } else {
            addToBackStack(null)
            R.id.activity_noticias_container1
        }
    ...
    private fun configuraListaNoticias(fragment: ListaNoticiasFragment) {
        ...
        fragment.quandoFabSalvaNoticia = this::abreFormularioModoCriacao
    }
    ...
    private fun configuraVisualizaNoticia(fragment: VisualizaNoticiaFragment) {
        ...
        private fun abreListaNoticias() {
            transacaoFragment {
                replace(R.id.activity_noticias_container1, ListaNoticiasFragment())
            }
        }
